<div class="flex flex-wrap p-6 lg:p-8 w-full">
    <div class="w-full sm:w-1/2 md:w-1/4 lg:w-1/4 p-2">
        <div class="bg-white border-b border-gray-200 overflow-hidden shadow-xl sm:rounded-lg min-h-[10rem] max-h-[10rem]"><x-card-clients /></div>
    </div>
    <div class="w-full sm:w-1/2 md:w-1/4 lg:w-1/4 p-2">
        <div class="bg-white border-b border-gray-200 overflow-hidden shadow-xl sm:rounded-lg min-h-[10rem] max-h-[10rem]"><x-card-organizers /></div>
    </div>
    <div class="w-full sm:w-1/2 md:w-1/4 lg:w-1/4 p-2">
        <div class="bg-white border-b border-gray-200 overflow-hidden shadow-xl sm:rounded-lg min-h-[10rem] max-h-[10rem]"><x-card-events /></div>
    </div>
    <div class="w-full sm:w-1/2 md:w-1/4 lg:w-1/4 p-2">
        <div class="bg-white border-b border-gray-200 overflow-hidden shadow-xl sm:rounded-lg min-h-[10rem] max-h-[10rem]"><x-card-tickets /></div>
    </div>
