{{-- <a href="#" class="block max-w-full max-h-full p-12 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
    ...
    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{$totalEvents}}</h5>
...
<a href="#" class="block max-w-full max-h-full py-8 px-8 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="20" height="20" style="margin-bottom: 6px">
    ...
    <div>
        <h5 class="mb-1 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">{{$totalEvents}}</h5>
    </div>
    <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Total Events</p>
</a>