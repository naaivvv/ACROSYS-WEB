<div class="w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
    <div class="flex justify-between">
      <div>
        <h5 class="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">{{$attendeesThisMonthForOrg}}</h5>
        <p class="text-base font-normal text-gray-500 dark:text-gray-400">New attendees this month</p>
      </div>
      <div
    ...
    <div class="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between">
      <div class="flex justify-end items-center pt-5">
        ...
        <a
          href="{{ route('admin.organizers') }}" :active="request()->routeIs('admin.organizers')"
